...
const ContactSection = () => {
    return (
        <section data-aos="fade-up" className="relative z-10 overflow-hidden bg-state-200 py-20">
            <div className="container mx-auto">
            <span className="text-primary uppercase text-3xl mb-4 block text-center font-semibold">
                                Contact Us
                            </span>
                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        <div className="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            <p className="text-body-color mb-9 text-base leading-relaxed">
                                Your complete satisfaction is our #1 priority.  If you have questions about your order, or about any of our products or policies, we'll be happy to get back to you promptly with the information you need.
                            </p>
                            ...
                            <div className="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-body-color text-base">+1-123-456-7890</p>
                                </div>
                            </div>
                            <div className="mb-8 flex w-full max-w-[370px]">
                                <div
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-body-color text-base">info@toykingdom.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                            <form>
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="bg-color  border-gradient-to-r from-purple-500 via-pink-500 to-red-500 w-full rounded border p-3 text-blue"
                                    >
                                        Send Message
                                    </button>
                                </div>
